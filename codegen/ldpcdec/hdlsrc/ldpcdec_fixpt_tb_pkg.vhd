-- -------------------------------------------------------------
-- 
-- File Name: /home/sky/Documents/MATLAB/Low_density_parity_code/codegen/ldpcdec/hdlsrc/ldpcdec_fixpt_tb_pkg.vhd
...
PACKAGE ldpcdec_fixpt_tb_pkg IS
  -- Functions
  ...
  FUNCTION to_hex(x : IN vector_of_signed2) RETURN string;
  FUNCTION to_hex(x : IN vector_of_signed10) RETURN string;
END ldpcdec_fixpt_tb_pkg;


PACKAGE BODY ldpcdec_fixpt_tb_pkg IS
  ...
  FUNCTION to_hex(x : IN vector_of_signed2) RETURN string IS
    VARIABLE result : STRING(1 TO 14);
    VARIABLE i      : INTEGER;
    VARIABLE j      : INTEGER;
    VARIABLE k      : INTEGER;
    VARIABLE m      : INTEGER;
  ...
  FUNCTION to_hex(x : IN vector_of_signed10) RETURN string IS
