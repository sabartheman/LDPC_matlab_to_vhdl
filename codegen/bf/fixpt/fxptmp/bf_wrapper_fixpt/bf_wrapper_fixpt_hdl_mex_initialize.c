 ...
 *
 * Code generation for function 'bf_wrapper_fixpt_hdl_mex_initialize'
 *
 */
...
static void bf_wrapper_fixpt_hdl_mex_once(const emlrtStack *sp);
...
static void bf_wrapper_fixpt_hdl_mex_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&c_eml_mx, numerictype(sp, "SignednessBool", false, "Signedness",
    "Unsigned", "WordLength", 7.0, "FractionLength", 0.0, "BinaryPoint", 0.0,
  ...
  st.site = NULL;
  bf_fixpt_logger_init();
  st.site = NULL;
  r_TB_logger_init(&st);
  st.site = NULL;
  iter_TB_logger_init(&st);
  st.site = NULL;
  out_TB_logger_init(&st);
}
  ...
  real_T qb, const char * rb, real_T sb, emlrtMCInfo *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &m6, 42, pArrays, "fimath", true, location);
}
  ...
  char * n, real_T o, emlrtMCInfo *location)
{
  ...
  pArrays[12] = emlrtCreateString(n);
  pArrays[13] = emlrtCreateDoubleScalar(o);
  return emlrtCallMATLABR2012b(sp, 1, &m5, 14, pArrays, "numerictype", true,
    location);
}

void bf_wrapper_fixpt_hdl_mex_initialize(void)
{
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    bf_wrapper_fixpt_hdl_mex_once(&st);
  }
}

/* End of code generation (bf_wrapper_fixpt_hdl_mex_initialize.c) */
