...
static emlrtRSInfo e_emlrtRSI = { 13,  /* lineNo */
  ...
  "/home/sky/Documents/MATLAB/Low_density_parity_code/codegen/call_custom_exp/fixpt/fxptmp/call_custom_exp_fixpt_logger.m"/* pathName */
};
...
static emlrtMCInfo b_emlrtMCI = { 18,  /* lineNo */
  ...
  "/home/sky/Documents/MATLAB/Low_density_parity_code/codegen/call_custom_exp/fixpt/fxptmp/call_custom_exp_fixpt_logger.m"/* pName */
};
...
static void b_y_TB_logger(const emlrtStack *sp, emxArray_uint16_T *out);
...
static void y_TB_logger(const emlrtStack *sp, uint16_T v);
...
static void b_x_TB_logger(const emlrtStack *sp, emxArray_int16_T *out)
{
  ...
  out->size[0] = 1;
  out->size[1] = p->size[1];
  emxEnsureCapacity_int16_T(sp, out, i12, &e_emlrtRTEI);
  loop_ub = p->size[0] * p->size[1];
  for (i12 = 0; i12 < loop_ub; i12++) {
    out->data[i12] = p->data[i12];
  }
...
static void b_y_TB_logger(const emlrtStack *sp, emxArray_uint16_T *out)
{
  ...
  emxEnsureCapacity_uint16_T(sp, out, i13, &f_emlrtRTEI);
  loop_ub = b_p->size[0] * b_p->size[1];
  for (i13 = 0; i13 < loop_ub; i13++) {
    out->data[i13] = b_p->data[i13];
  }
...
static void x_TB_logger(const emlrtStack *sp, int16_T v)
{
  ...
  p->size[1] = i8 + 1;
  emxEnsureCapacity_int16_T(sp, p, i9, &c_emlrtRTEI);
  p->data[i8] = v;
  p_not_empty = true;
}
...
static void y_TB_logger(const emlrtStack *sp, uint16_T v)
{
  ...
  i10 = b_p->size[1];
  i11 = b_p->size[0] * b_p->size[1];
  b_p->size[1] = i10 + 1;
  emxEnsureCapacity_uint16_T(sp, b_p, i11, &d_emlrtRTEI);
  b_p->data[i10] = v;
  b_p_not_empty = true;
}
...
{
  emxInit_uint16_T(sp, &b_p, 2, &b_emlrtRTEI, false);
  b_p_not_empty = false;
}
